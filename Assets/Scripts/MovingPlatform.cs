...
public class MovingPlatform : MonoBehaviour
{
    ...
    [SerializeField] private float waitTime;            // wayPoint 도착 후 대기시간
    [SerializeField]
    ...
    {
        if(collision.transform.CompareTag("Player"))    // 플레이어와 이동발판이 충돌하면
        {
    ...
    {
        if(collision.transform.CompareTag("Player"))    // 플레이어와 이동발판이 해제되면
        {
